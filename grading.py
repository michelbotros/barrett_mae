...
class SlideGradeModel(pl.LightningModule):
    ...
    """
    def __init__(self, exp_dir=None, run_dir=None):
        super().__init__()
        self.model = SetTransformer(dim_input=4, num_outputs=1, dim_hidden=16, num_heads=1, dim_output=3)
    ...
    def configure_optimizers(self, init_lr=1e-4, wd=1e-5, scheduler_patience=100, scheduler_factor=0.2):
    ...
    def test_epoch_end(self, outputs):
        ...
        plot_confusion_matrix(cm, save_path=os.path.join(self.run_dir, 'test_cm.png'), pixel_level=False, normalized=False, kappa=kappa)
...
def train(run_name, nr_epochs, batch_size, lr, wd, experiments_dir, wandb_key, test_mode):
    """ Train something (Transformer/Graph NN) for slide level classification.
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument("--batch_size", type=int, default=256, help="the size of mini batches")
    ...
    parser.add_argument("--exp_dir", type=str,
                        default='/data/archief/AMC-data/Barrett/experiments/LANS/',
